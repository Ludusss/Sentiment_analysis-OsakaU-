...
def main():
    ...
    parser.add_argument('--use_quad_classes', type=bool, default=False,
                        help='Use 4 class classifier (default: False')
    ...
    parser.add_argument('--save_model_threshold_text', type=float, default=88,
                        help='threshold for saving text model (default: 88)')
    parser.add_argument('--save_model_threshold_audio', type=float, default=89,
    ...
    if not args.use_pretrained:
        ...
        if args.use_quad_classes:
            text_model_info = torch.load("saved_models/text_lstm/4_model_acc_90.65.t")
        else:
        ...
        if args.use_quad_classes:
            audio_model_info = torch.load("saved_models/audio_lstm/4_model_acc_90.86.a")
        else:
