...
def main():
    ...
    parser.add_argument('--dropout_audio', type=float, default=0.2554070776341251,
                        help='dropout p value for audio model (default: 0.2554070776341251)')
    ...
    for i in range(10):
        ...
        if args.use_quad_classes:
            ...
            model_audio = MLP(input_feature_size=audio_train.shape[-1], hidden_size=args.hidden_size_audio, n_classes=4,
                              n_layers=args.n_layers_audio, device=device, p=args.dropout_audio)
        else:
            ...
            model_audio = MLP(input_feature_size=audio_train.shape[-1], hidden_size=args.hidden_size_audio, n_classes=3,
                              n_layers=args.n_layers_audio, device=device, p=args.dropout_audio)
